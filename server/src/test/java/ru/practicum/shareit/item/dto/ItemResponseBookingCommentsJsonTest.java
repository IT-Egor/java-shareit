...
@JsonTest
public class ItemResponseBookingCommentsJsonTest {

    @Autowired
    private JacksonTester<ItemResponseBookingComments> jsonTester;
    ...
    void testItemResponseBookingCommentsSerialization() throws Exception {
        ...
        ItemResponseBookingComments response = ItemResponseBookingComments.builder()
                .id(1L)
                .name("Item 1")
        ...
        JsonContent<ItemResponseBookingComments> json = jsonTester.write(response);
    ...
    void testItemResponseBookingCommentsDeserialization() throws Exception {
        ...
        ItemResponseBookingComments response = jsonTester.parseObject(jsonContent);
